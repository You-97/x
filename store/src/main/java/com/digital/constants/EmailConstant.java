...
public class EmailConstant {
    ...
    public static final String USERNAME = "mega.youssef.el.gourari@gmail.com";
    public static final String PASSWORD = "gqpiynmqashyiwpa";
    public static final String FROM_EMAIL = "mega.youssef.el.gourari@gmail.com";
